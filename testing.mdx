...
<CardGroup cols={2}>
  ...
  <Card title="_reset_remote_router_globals" icon="rotate">
    ...
    Without it, a test that builds over `blog_app`, which sets `remote.explicit_optin: true`, could leak that setting into unrelated tests running later in the same process.
  </Card>
</CardGroup>
